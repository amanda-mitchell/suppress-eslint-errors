...
`
  ...
  expect(modifySource(program, { message: 'Something more informative' })).resolves.toBe(`export function foo(a, b) {
...
test('supports alternative messages in jsx', () => {
  ...
  expect(modifySource(program, { message: 'Something more informative' })).resolves.toBe(`export function Component({ a, b }) {
  return (
    (<div>
      {/* Something more informative */}
      {/* eslint-disable-next-line eqeqeq */}
